...
func (e PostEdges) DocumentOrErr() ([]*Document, error) {
	if e.loadedTypes[0] {
...
func (*Post) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case post.FieldTitle, post.FieldBody, post.FieldImgPath:
...
// QueryDocument queries the "document" edge of the Post entity.
func (po *Post) QueryDocument() *DocumentQuery {
	return (&PostClient{config: po.config}).QueryDocument(po)
}
...
func (po *Post) String() string {
	...
	builder.WriteString(po.ImgPath)
